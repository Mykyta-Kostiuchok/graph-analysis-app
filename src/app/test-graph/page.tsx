...
} from "@/components/graph/ForceSimulation";
...
export default function TestGraphPage() {
  ...
  return (
    <div className="container py-8 space-y-8 relative">
      <h1 className="text-3xl font-bold">Test wizualizacji grafu</h1>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="relative">
          <h2 className="text-xl font-semibold mb-4">Bazowa wizualizacja</h2>
          <GraphCanvas
            ref={canvasRef}
            graphData={testData}
            width={400}
